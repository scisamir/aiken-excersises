...
const unsignedTx = await txBuilder
    .txIn(validationUtxo.input.txHash, validationUtxo.input.outputIndex, validationUtxo.output.amount, validationUtxo.output.address)
    .txInScript(multiSigCbor)
    .spendingPlutusScript('V3')
    .txIn(lockedUTxo.input.txHash, lockedUTxo.input.outputIndex, lockedUTxo.output.amount, scriptAddrMultisig)
